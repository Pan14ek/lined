...
## Intent
Translate one interface into the contract callers already understand.
...
## Signals
Provider details must stay behind a seam.

## Applicability
The client calls Target; Adapter translates to Adaptee and maps results/errors. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
The client calls Target; Adapter translates to Adaptee and maps results/errors.
