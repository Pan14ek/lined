...
## Intent
Separate a stable abstraction from an independently varying implementation.
...
## Signals
A hierarchy would multiply combinations.

## Applicability
The abstraction delegates implementation work through a narrow implementor contract. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
The abstraction delegates implementation work through a narrow implementor contract.
