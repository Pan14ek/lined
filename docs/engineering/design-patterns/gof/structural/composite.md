...
## Intent
Treat individual objects and groups uniformly through a tree contract.
...
## Signals
The tree has meaningful recursive semantics.

## Applicability
Composite delegates to children and combines results. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
Composite delegates to children and combines results.
