...
## Signals
Decorators preserve the wrapped contract and have meaningful ordering.

## Applicability
Each decorator delegates and adds a bounded concern. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
Each decorator delegates and adds a bounded concern.
