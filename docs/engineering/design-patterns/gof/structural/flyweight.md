...
## Intent
Share immutable intrinsic state while keeping request-specific state outside.
...
## Signals
Identity and mutability boundaries are explicit.

## Applicability
Clients supply extrinsic state while the shared object provides intrinsic behavior. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Flyweight, factory/cache, extrinsic state.

## Participants
Flyweight, factory/cache, extrinsic state.

## Execution / collaboration
Clients supply extrinsic state while the shared object provides intrinsic behavior.
