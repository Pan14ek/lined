...
## Intent
Add operations over a stable object structure without changing node classes.
...
## Signals
Visitor can be awkward when node types change often.

## Applicability
Elements dispatch to the visitor; visitor performs type-specific work. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Visitor, concrete visitor, element, concrete elements.

## Participants
Visitor, concrete visitor, element, concrete elements.

## Execution / collaboration
Elements dispatch to the visitor; visitor performs type-specific work.
