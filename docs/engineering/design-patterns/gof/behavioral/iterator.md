...
## Signals
Native language iteration is usually enough.

## Applicability
Iterator tracks position and returns next elements. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Iterator, aggregate, concrete iterator.

## Participants
Iterator, aggregate, concrete iterator.

## Execution / collaboration
Iterator tracks position and returns next elements.
