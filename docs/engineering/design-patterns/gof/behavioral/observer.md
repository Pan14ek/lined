...
## Intent
Notify interested subscribers when a subject changes.
...
## Signals
Ordering, failure isolation, and unsubscribe behavior matter.

## Applicability
Subject publishes an event; observers react through a contract. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Subject, observer, concrete observers.

## Participants
Subject, observer, concrete observers.

## Execution / collaboration
Subject publishes an event; observers react through a contract.
