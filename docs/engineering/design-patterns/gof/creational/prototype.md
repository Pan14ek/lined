...
## Intent
Create a new object by copying a configured exemplar.
...
## Signals
A reliable copy boundary and explicit clone semantics are required.

## Applicability
The client requests a copy and then applies safe changes. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Prototype and concrete prototype.

## Participants
Prototype and concrete prototype.

## Execution / collaboration
The client requests a copy and then applies safe changes.
