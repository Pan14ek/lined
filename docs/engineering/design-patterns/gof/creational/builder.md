...
## Intent
Construct a complex object through explicit validated steps.
...
## Signals
Too many constructor arguments and invalid partial objects are signals.

## Applicability
The builder accumulates validated state and produces an immutable product. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Builder, product, and step operations.

## Participants
Builder, product, and step operations.

## Execution / collaboration
The builder accumulates validated state and produces an immutable product.
