...
## Intent
Let a creator choose a concrete product while callers depend on a product contract.
...
## Signals
New product types should be added without changing the workflow.

## Applicability
The creator invokes a factory seam and uses only the product contract. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
The creator invokes a factory seam and uses only the product contract.
