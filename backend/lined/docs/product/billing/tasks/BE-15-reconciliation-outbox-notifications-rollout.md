...
6. **Structured logs** — MDC entries per §50.2 (`correlationId`,
   ...
   `operation`).
7. **Alerts** — document alert queries in the planned `docs/product/billing/OBSERVABILITY.md`
...
11. Write the planned `docs/product/billing/OBSERVABILITY.md` with alert queries.
