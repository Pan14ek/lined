...
One class owns too many responsibilities or change reasons. Extract Class, Move Method, Extract Subclass

## Definition
One class owns too many responsibilities or change reasons.

## Typical signals
Many unrelated collaborators, fields, and test fixtures; frequent merge conflicts.
...
A cohesive aggregate may be large because its invariant belongs together.
