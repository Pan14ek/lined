...
A method has accumulated multiple decisions, transformations, and side effects. Extract Method, Decompose Conditional, Replace Temp with Query

## Definition
A method has accumulated multiple decisions, transformations, and side effects.

## Typical signals
Long branches, difficult naming, repeated setup, or tests that need many unrelated fixtures.
...
A short method can still be obscure; extraction is harmful when it hides one cohesive algorithm.
