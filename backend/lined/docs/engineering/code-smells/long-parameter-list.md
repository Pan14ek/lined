...
A call requires many values whose relationship is hard to see. Introduce Parameter Object, Preserve Whole Object, Move Method

## Definition
A call requires many values whose relationship is hard to see.

## Typical signals
Repeated argument groups, order mistakes, and call sites that construct the same cluster.
...
A small stable command may legitimately need several explicit values.
