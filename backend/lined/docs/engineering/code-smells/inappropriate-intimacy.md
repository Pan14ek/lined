...
Two modules know each other's internals and lifecycle details. Move Method, Extract Class, Hide Delegate

## Definition
Two modules know each other's internals and lifecycle details.

## Typical signals
Bidirectional dependencies, private-field access, and coordinated changes.
...
A cohesive aggregate may legitimately coordinate internal state.
