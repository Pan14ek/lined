...
A subclass inherits behavior or data it cannot honor. Replace Inheritance with Delegation, Push Down Method, Extract Interface

## Definition
A subclass inherits behavior or data it cannot honor.

## Typical signals
Overrides that throw, unused inherited API, or surprising parent invariants.
...
A subclass may intentionally narrow a stable framework contract.
