...
Unreachable or unused code obscures the supported design. Remove Dead Code, Inline Class, Collapse Hierarchy

## Definition
Unreachable or unused code obscures the supported design.

## Typical signals
Unused branches, stale flags, no consumers, or code excluded by every route.
...
Reflection, configuration, and migration compatibility can hide consumers.
