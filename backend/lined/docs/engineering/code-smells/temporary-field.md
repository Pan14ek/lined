...
An object field is meaningful only during a narrow workflow. Extract Class, Introduce Parameter Object, Replace Temp with Query

## Definition
An object field is meaningful only during a narrow workflow.

## Typical signals
Nullable fields, lifecycle comments, or methods that only work after setup.
...
ORM entities and framework lifecycle fields may look temporary but be required.
