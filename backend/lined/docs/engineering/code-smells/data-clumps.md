...
The same values travel together across unrelated signatures or fields. Introduce Parameter Object, Extract Class, Move Method

## Definition
The same values travel together across unrelated signatures or fields.

## Typical signals
Repeated pairs/triples such as from/to windows or identity plus lobby.
...
Coincidental field adjacency is not enough; look for shared invariant.
