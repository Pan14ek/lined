...
## Intent
Remove an inverse link that leaks or complicates ownership.

## Problem
The inverse is unused or creates lifecycle and serialization hazards.

## Preconditions
Choose the authoritative direction, migrate callers, and verify persistence queries. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
