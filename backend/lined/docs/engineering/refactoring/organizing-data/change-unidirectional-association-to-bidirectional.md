...
## Intent
Add the inverse navigation needed by a real invariant or query.

## Problem
Callers repeatedly search for the inverse relationship and ownership is clear.

## Preconditions
Define lifecycle ownership, update both sides, and test persistence mapping. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
