...
## Intent
Replace changing behavior branches with a state/strategy collaborator.

## Problem
Behavior varies over time or by algorithm and cases grow.

## Preconditions
Define a focused interface, real implementations, and explicit transition/selection ownership. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
