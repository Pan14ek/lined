...
## Intent
Use subclasses when variants have stable distinct behavior and lifecycle.

## Problem
Many branches choose invariant behavior by a type code.

## Preconditions
Move behavior into subclasses while preserving the external contract. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
