...
## Intent
Give a primitive value a type that owns validation and meaning.

## Problem
The same parsing or invariant appears in several call sites.

## Preconditions
Create a value object, migrate construction at the boundary, and keep storage mapping explicit. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
