...
## Intent
Replace positional data with named fields.

## Problem
Indexes obscure meaning or allow invalid combinations.

## Preconditions
Introduce a small type/object, migrate construction, and keep order only where protocol requires it. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
