...
## Intent
Move identical work outside branches.

## Problem
Both branches perform the same side effect or mapping.

## Preconditions
Prove the fragment is independent of branch state, move it, and rerun tests. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
