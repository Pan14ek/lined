...
## Intent
Name condition, consequence, and alternative parts of a complex branch.

## Problem
A conditional mixes policy, calculation, and side effects.

## Preconditions
Extract predicates and actions, then verify evaluation order and short-circuiting. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
