...
## Intent
Make exceptional or invalid cases exit early.

## Problem
Deep nesting hides the normal path and multiplies indentation.

## Preconditions
Add guards in behavior-preserving order, then simplify the happy path. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
