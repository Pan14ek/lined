...
## Intent
Stop callers navigating an object's internal collaborator.

## Problem
Message chains expose structure and spread knowledge.

## Preconditions
Add an intention-revealing method at the owner, migrate callers, and keep delegate private. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
