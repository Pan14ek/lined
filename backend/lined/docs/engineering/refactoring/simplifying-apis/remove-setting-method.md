...
## Intent
Prevent arbitrary post-construction mutation.

## Problem
A setter allows invalid lifecycle transitions or is unused.

## Preconditions
Make state constructor/factory-owned, remove setter, and migrate valid updates to named methods. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
