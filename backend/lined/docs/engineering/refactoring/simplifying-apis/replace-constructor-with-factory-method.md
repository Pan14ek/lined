...
## Intent
Give construction a domain name or select among variants.

## Problem
Constructors cannot express intent or validation cleanly.

## Preconditions
Introduce a named factory, migrate callers, and keep invariants at construction. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
