...
## Intent
Share common construction steps while retaining variant inputs.

## Problem
Sibling constructors repeat initialization order.

## Preconditions
Extract a safe common step/factory and preserve framework construction constraints. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
