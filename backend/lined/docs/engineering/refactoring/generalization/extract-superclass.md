...
## Intent
Share genuinely common state and behavior among related classes.

## Problem
Siblings duplicate a cohesive contract and have a stable abstraction.

## Preconditions
Move only the common portion and verify ownership. Confirm ownership, search the Pattern Registry, and add characterization tests if the change can affect behavior.
