...
## Intent
Create compatible families of related objects without coupling callers to concrete classes.
...
## Signals
Family selection, not one object construction, is the signal.

## Applicability
The chosen factory creates matching products; clients use product contracts. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Factory, concrete factories, and family products.

## Participants
Factory, concrete factories, and family products.

## Execution / collaboration
The chosen factory creates matching products; clients use product contracts.
