...
## Intent
Fix workflow ordering while allowing selected steps to vary.
...
## Signals
Prefer composition when runtime selection or multiple dimensions vary.

## Applicability
Template owns order; subclasses implement bounded steps. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Abstract class, template, primitive operations, concrete classes.

## Participants
Abstract class, template, primitive operations, concrete classes.

## Execution / collaboration
Template owns order; subclasses implement bounded steps.
