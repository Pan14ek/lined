...
## Intent
Pass a request through ordered handlers until one handles it.
...
## Signals
Ownership, termination, and diagnostics must be explicit.

## Applicability
Each handler handles or delegates to its successor. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Handler, concrete handlers, client.

## Participants
Handler, concrete handlers, client.

## Execution / collaboration
Each handler handles or delegates to its successor.
