...
## Intent
Evaluate expressions in a small, stable language.
...
## Signals
Do not build a parser for ordinary branching or user-provided arbitrary code.

## Applicability
Expressions evaluate against a context and compose recursively. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Abstract expression and terminal/nonterminal expressions.

## Participants
Abstract expression and terminal/nonterminal expressions.

## Execution / collaboration
Expressions evaluate against a context and compose recursively.
