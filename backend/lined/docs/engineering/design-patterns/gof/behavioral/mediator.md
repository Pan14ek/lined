...
## Intent
Coordinate peer interactions through a dedicated collaboration owner.
...
## Signals
The mediator must own a real workflow, not become a god object.

## Applicability
Colleagues notify mediator; mediator coordinates peers. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Mediator, colleagues, client.

## Participants
Mediator, colleagues, client.

## Execution / collaboration
Colleagues notify mediator; mediator coordinates peers.
