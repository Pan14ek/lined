...
## Intent
Select one of several interchangeable algorithms behind a focused contract.
...
## Signals
A small closed mapping may be clearer than strategies.

## Applicability
Context supplies inputs and delegates the algorithm. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
## Structure
Context, strategy, concrete strategies.

## Participants
Context, strategy, concrete strategies.

## Execution / collaboration
Context supplies inputs and delegates the algorithm.
