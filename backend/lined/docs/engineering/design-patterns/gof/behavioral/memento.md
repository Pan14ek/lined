...
## Intent
Capture and restore state without exposing its internals.
...
## Signals
Snapshot size, consistency, and lifecycle must be explicit.

## Applicability
Originator creates/restores; caretaker stores without inspecting. The contract should be small enough to test and the owner should be discoverable in the Pattern Registry when used in Lined.
...
Originator creates/restores; caretaker stores without inspecting.
