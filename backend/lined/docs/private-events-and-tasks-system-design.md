...
**Suggested document path:** `backend/lined/docs/private-events-and-tasks-system-design.md`
...
order) plus 3 web tasks tracked in `lined-web/docs/UI_TASKS.md` (UI-51 to
