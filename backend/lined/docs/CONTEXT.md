...
Use this table to locate the canonical home for backend documentation. The
root [README](README.md) is the entrypoint; folders below own the detailed
documents for their domain.
...
| Engineering quality | Backend-owned reuse, refactoring, Spring patterns, Guardian, and quality-gate guidance; shared GoF and registry guidance lives at the monorepo root. | `docs/engineering/` and `../../../docs/engineering/` |
