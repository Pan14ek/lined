...
- rule-suggestion evaluation rooted in `docs/llm-support-service.md`, a
  `Research Workflow for Agents` Notion snapshot, and a fixed-medium runtime
  summary fixture;
- research-summary evaluation rooted in
  `docs/runtime-quality-scenario-catalog.md`, an `Experiment Design and
  ...
  "loaded_sources": [
    {
      ...
      "kind": "repo-doc",
      "path": "docs/llm-support-service.md"
    }
  ],
  "output": {}
}
