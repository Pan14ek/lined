...
```json
{
  ...
  "advisory_metadata": {
    ...
    "retrieved_sources": [
      "docs/research/ai/llm-support-service.md",
...
Run `docs/research/ai/llm-rule-validation-checklist.md` after this workflow when you need
...
Run `docs/research/ai/llm-guardrail-evaluation.md` after the checklist when you need the
