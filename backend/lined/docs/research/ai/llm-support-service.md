...
promoted state. `docs/research/ai/llm-rule-review-workflow.md` defines the separate review
...
node load-tests/runtime-scenarios/llm-support-service-cli.mjs \
  --provider mock \
  --requirements-md docs/research/ai/llm-support-service.md \
...
Use `docs/research/ai/llm-rule-review-workflow.md` when you need the executable review and
promotion workflow that applies these checks to each candidate rule.

Use `docs/research/ai/llm-rule-validation-checklist.md` after review when you need an
...
Use `docs/research/ai/llm-guardrail-evaluation.md` after the reviewed-rule and explanation
...
Use `docs/research/ai/llm-tradeoff-explanations.md` when you need reviewed explanation
