...
constraint set in `docs/research/platform/slo-constraint-thresholds.md` and the versioned
...
`docs/research/platform/runtime-scenario-summaries.md`, the collector may auto-discover that
...
1. Verify the active scenario and workload prerequisites from
   `docs/research/platform/runtime-scenario-summaries.md`.
