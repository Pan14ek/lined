...
See `docs/research/platform/runtime-metrics-baseline.md` for the runtime signal map and the
Prometheus scrape expectations for this baseline.
See `docs/research/platform/prometheus-telemetry-pipeline.md` when you need a local Prometheus
