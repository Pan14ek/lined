...
Complete the kind baseline from `docs/research/platform/kind-baseline.md` first:
...
`docs/research/platform/load-test-baseline.md`.
...
`docs/research/platform/hpa-resource-scenarios.md`, run the selected workload profile, then query
...
`docs/research/platform/kind-baseline.md` for full baseline cleanup.
