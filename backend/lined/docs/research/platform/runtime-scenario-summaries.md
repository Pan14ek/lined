...
- deploy the local kind backend from `docs/research/platform/kind-baseline.md`;
...
`docs/research/platform/hpa-resource-scenarios.md`:
...
Workloads are the existing k6 profiles from `docs/research/platform/load-test-baseline.md`:
