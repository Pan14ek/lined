...
| `telemetry-contract` | Comes from the runtime summary fields documented in `docs/research/fitness/runtime-fitness-extension.md`. |
...
- `docs/research/platform/load-test-baseline.md` defines k6 pass/fail guardrails for workload
  reproducibility. This document defines experiment classification thresholds.
- `docs/research/platform/runtime-metrics-baseline.md` and
  `docs/research/platform/prometheus-telemetry-pipeline.md` define metric sources and PromQL
  query direction.
- `docs/research/platform/hpa-resource-scenarios.md` defines scenario inputs whose resource
  pressure should be interpreted with workload and HPA context.
- `docs/research/fitness/runtime-fitness-extension.md` defines the runtime summary shape that
