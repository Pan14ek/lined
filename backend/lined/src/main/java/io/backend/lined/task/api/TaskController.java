 ...
 *
 * <p>Caller identity comes from the authenticated Spring Security context, so a list request can
 * return shared tasks plus the caller's private tasks without trusting request data.</p>
 */
...
public class TaskController {
  ...
  public ResponseEntity<TaskDto> create(
    ...
    TaskDto created = service.create(dto, currentUserProvider.requireUserId(), idempotencyKey);
  ...
  public ResponseEntity<TaskDto> update(
    ...
    TaskDto updated = service.update(id, dto, currentUserProvider.requireUserId(),
  ...
  public List<TaskDto> list(
    ...
    return service.list(lobbyId, assigneeId, status, currentUserProvider.requireUserId());
  }
