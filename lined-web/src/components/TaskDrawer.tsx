...
import type { LobbyDto, TaskDto, TaskPriority, TaskStatus, TaskUpdateDto } from '@/types';
import { useCreateTask, useUpdateTask, useDeleteTask } from '@/hooks/useTasks';
import { useUser, useUsers } from '@/hooks/useUsers';
import { TASK_STATUS_LABELS, TASK_PRIORITY_LABELS, TASK_PRIORITY_OPTIONS } from '@/lib/constants';
import { getApiErrorMessage } from '@/lib/apiErrors';
import { formatShortDate } from '@/lib/calendarUtils';
...
function getTaskErrorMessage(error: unknown, isEditMode: boolean): string {
...
function getDeleteTaskErrorMessage(error: unknown): string {
  return getApiErrorMessage(error, {}, "Couldn't delete this task — please try again");
}

/** Only the fields that differ from `task` — mirrors CreateEventModal/ProfileCard's changed-fields discipline. */
function buildTaskPatch(task: TaskDto, form: TaskFormValues): TaskUpdateDto {
