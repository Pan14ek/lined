...
export const MOCK_NOTIFICATIONS: NotificationDto[] = [
  {
    ...
    messageKey: 'notificationMessages.taskAssigned',
    messageParams: { taskTitle: 'Plan dinner for Saturday' },
    lobbyId: 1,
    taskId: 1,
    eventId: null,
    readAt: null,
  ...
  },
  {
    ...
    messageKey: 'notificationMessages.sharedEventCreated',
    messageParams: { eventTitle: 'Family Dinner', lobbyName: 'Johnson Family' },
    lobbyId: 2,
    taskId: null,
    eventId: 3,
  ...
  },
  {
    ...
    messageKey: 'notificationMessages.taskAssigned',
    messageParams: { taskTitle: 'Prepare quarterly roadmap deck' },
    lobbyId: 4,
    taskId: 10,
    eventId: null,
    readAt: null,
