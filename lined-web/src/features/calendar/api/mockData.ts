...
export const MOCK_EVENTS: EventDto[] = [
  ...
  {
    id: 14,
    // Private-event owner fixture (user 1) -- visible only to user 1.
    title: 'Pick up the gift',
    location: 'Parcel locker',
    shared: false,
    visibility: 'PRIVATE',
    startAt: `${tomorrowStr}T10:00:00Z`,
    endAt: `${tomorrowStr}T11:00:00Z`,
    timezone: 'UTC',
    lobbyId: 1,
    ownerId: 1,
  ...
  {
    id: 15,
    // Private-event non-owner fixture (user 2) -- must never reach user 1's
    // responses; used to assert the requester-aware list filter.
    title: 'Therapy appointment',
    location: 'Downtown Clinic',
    shared: false,
    visibility: 'PRIVATE',
    startAt: `${dayAfterStr}T09:00:00Z`,
    endAt: `${dayAfterStr}T10:00:00Z`,
    timezone: 'UTC',
    lobbyId: 1,
    ownerId: 2,
