...
export const updateEvent = async (id: number, data: EventUpdateDto, _version = 0): Promise<EventDto> => {
  await mockDelay();
...
export const deleteEvent = async (id: number, _version = 0): Promise<void> => {
  await mockDelay();
